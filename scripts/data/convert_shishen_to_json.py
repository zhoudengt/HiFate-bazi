...
def convert_shishen_excel_to_json(excel_path: str, output_path: str = None):
    """
    将十神命格 Excel 文件转换为 JSON 格式
...
def main():
    """主函数"""
    excel_path = os.path.join(project_root, 'docs', '十神命格.xlsx')
    output_path = os.path.join(project_root, 'docs', '十神命格.json')
    
    print("=" * 60)
    print("十神命格 Excel 转 JSON 工具")
    print("=" * 60)
    
    success = convert_shishen_excel_to_json(excel_path, output_path)
