...
echo -e "  - 算法公式: ${GREEN}http://${SERVER_IP}:8001/local_frontend/formula-analysis.html${NC}"
echo -e "  - 运势分析: ${GREEN}http://${SERVER_IP}:8001/local_frontend/fortune.html${NC}"
echo -e "  - 面相分析 V2: ${GREEN}http://${SERVER_IP}:8001/local_frontend/face-analysis-v2.html${NC}"
echo -e "  - 办公桌风水: ${GREEN}http://${SERVER_IP}:8001/local_frontend/desk-fengshui.html${NC}"
echo ""
echo -e "常用命令："
