...
"""
数据库配置模块 - 支持本地开发和生产环境
本地开发连接Node1公网IP，生产环境连接Node1内网IP
"""
...
MYSQL_PASSWORD = os.getenv("MYSQL_PASSWORD", os.getenv("MYSQL_ROOT_PASSWORD", "Yuanqizhan@163"))
...
MONGO_PASSWORD = os.getenv("MONGO_PASSWORD", "Yuanqizhan@163")
