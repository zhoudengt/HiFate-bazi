    ...
    def _get_default_config(self) -> Dict:
        ...
        return {
            ...
            'hidden_scores': [
                ...
                # 2个藏干：对应分值1 = 10.5, 对应分值2 = 4.5
                {'藏干数量': 2, '第1个匹配': 10.5, '第1个不匹配': -10.5, '第2个匹配': 4.5, '第2个不匹配': -4.5},
                # 3个藏干：对应分值1 = 9, 对应分值2 = 4.5, 对应分值3 = 1.5
                {'藏干数量': 3, '第1个匹配': 9, '第1个不匹配': -9, '第2个匹配': 4.5, '第2个不匹配': -4.5, '第3个匹配': 1.5, '第3个不匹配': -1.5},
            ],
            'thresholds': [
                {'旺衰状态': '身旺', '最小分数': 60, '最大分数': 100},
                {'旺衰状态': '平衡', '最小分数': 40, '最大分数': 59},
                {'旺衰状态': '身弱', '最小分数': 0, '最大分数': 39},
            ],
            'xi_ji': [
