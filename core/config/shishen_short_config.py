...
# 基于地支本气（第一藏干）+ 五行生克计算（正财=财，偏财=才，与问真一致）
DIZHI_SHISHEN_MAP = {
    '甲': {'子': '印', '丑': '财', '寅': '比', '卯': '劫', '辰': '才', '巳': '食', '午': '伤', '未': '财', '申': '杀', '酉': '官', '戌': '才', '亥': '枭'},
    '乙': {'子': '枭', '丑': '才', '寅': '劫', '卯': '比', '辰': '财', '巳': '伤', '午': '食', '未': '才', '申': '官', '酉': '杀', '戌': '财', '亥': '印'},
    '丙': {'子': '官', '丑': '伤', '寅': '枭', '卯': '印', '辰': '食', '巳': '比', '午': '劫', '未': '伤', '申': '才', '酉': '财', '戌': '食', '亥': '杀'},
    '丁': {'子': '杀', '丑': '食', '寅': '印', '卯': '枭', '辰': '伤', '巳': '劫', '午': '比', '未': '食', '申': '财', '酉': '才', '戌': '伤', '亥': '官'},
    '戊': {'子': '财', '丑': '劫', '寅': '杀', '卯': '官', '辰': '比', '巳': '枭', '午': '印', '未': '劫', '申': '食', '酉': '伤', '戌': '比', '亥': '才'},
    '己': {'子': '才', '丑': '比', '寅': '官', '卯': '杀', '辰': '劫', '巳': '印', '午': '枭', '未': '比', '申': '伤', '酉': '食', '戌': '劫', '亥': '财'},
    '庚': {'子': '伤', '丑': '印', '寅': '才', '卯': '财', '辰': '枭', '巳': '杀', '午': '官', '未': '印', '申': '比', '酉': '劫', '戌': '枭', '亥': '食'},
    '辛': {'子': '食', '丑': '枭', '寅': '财', '卯': '才', '辰': '印', '巳': '官', '午': '杀', '未': '枭', '申': '劫', '酉': '比', '戌': '印', '亥': '伤'},
    '壬': {'子': '劫', '丑': '官', '寅': '食', '卯': '伤', '辰': '杀', '巳': '才', '午': '财', '未': '官', '申': '枭', '酉': '印', '戌': '杀', '亥': '比'},
    '癸': {'子': '比', '丑': '杀', '寅': '伤', '卯': '食', '辰': '官', '巳': '财', '午': '才', '未': '杀', '申': '印', '酉': '枭', '戌': '官', '亥': '劫'},
}
